...
import static dev.barbz.subscriptionsysbff.domain.util.SubscriptionConstants.EMAIL_PATTERN;
import static dev.barbz.subscriptionsysbff.domain.util.SubscriptionConstants.NO_VALID_FIELD_EXCEPTION;
...
public class SubscriptionUtil {
    ...
    private static void validateFields(RegisterSubscriptionRequest subscriptionRequest) {
